...
import nagMessage from '../../../modules/parse/customrepoplugin.js';


export default async function execute(client, attachmentName, data) {
    ...
    */
	...
	if (foundCustomRepoPluginInstalled
		...
		replyEmbeds.push(nagMessage(client));
	}
