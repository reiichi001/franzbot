exports.answer = async client => ({
	title: `Please send us your velopack.log file`,
	description: `Please send us your **velopack.log** log file from `
		+ `\`%localappdata%\\XIVLauncher\\\` in this channel, so we can look into the problem!\n\n`
		...
		+ `named \`velopack\` on your computer.\n\n`
