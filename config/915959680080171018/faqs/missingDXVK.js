exports.answer = async client => ({
    ...
    + 'click that menu then click DXVK and the problem will be resolved. There is no visual feedback \n'
    + 'when running this, do not be alarmed. The process only takes a second or two.',
